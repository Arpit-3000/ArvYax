...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-green-50 via-blue-50 to-teal-100">
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 backdrop-blur-xl bg-white/60 rounded-md shadow-md">
      ...
      <div className="relative hidden lg:flex lg:w-1/2">
        ...
        <img
          ...
          src={yogaBg}
          alt="Woman meditating in a nature-inspired setting"
        />
